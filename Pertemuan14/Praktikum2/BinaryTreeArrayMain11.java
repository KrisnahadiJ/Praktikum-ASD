...
public class BinaryTreeArrayMain11 {
    public static void main(String[] args) {
        ...
        Mahasiswa11[] dataMahasiswa = {mhs1, mhs2, mhs3, mhs4, mhs5, mhs6, mhs7, null, null, null}; // eleman tetap, karena array di BinaryTreeArray11[10]
        ...
        bta.traversePreOrder(0); // Mulai traversal dari indeks 0 (root)
    }
}