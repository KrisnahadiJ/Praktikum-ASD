...
public class AntrianKRS11 {
    ...
    public void tambahAntrian11(Mahasiswa mhs) {
        if (IsFull()) {
    ...
    public void tampilkanPalingAkhir11() {
        if (IsEmpty()) {
            System.out.println("Antrian kosong.");
        } else {
    ...
    public void tampilkanDuaTerdepan11() {
        if (size < 2) {
